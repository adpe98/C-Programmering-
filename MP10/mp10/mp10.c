...
/* Description: Writes the dimensions of the game field to the output file 
 * and then calls the save_config_to_file function to write the game field configuration that same file.
 * Input: A file pointer to the output file and a field structure containing the game field.
 * Output: Writes the game field  to the output file. If the configuration cannot be saved successfully an error message will be printed to stderr. 
 */
void write_to_file(FILE *out_file_p, field game_field)
{
